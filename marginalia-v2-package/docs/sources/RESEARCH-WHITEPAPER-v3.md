...
1. **Selection or note.** The content script sends the span, selectors, section context, page metadata and any stated context. Selecting sends the passage to Codex only while the reader's instant help switch is on; Keep and Park never send anything.
