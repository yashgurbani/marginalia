...
Evidence (package-relative): `docs/evidence/qa-2026-09-18/e34-availability/{worker-report.md,main-test.log,main-typecheck.log,main-prepare.log,main-extension-typecheck.log}`; shared independent review: `docs/evidence/qa-2026-09-18/e32-e37-settings/independent-review.md`, also retained at `<repo>/.local/review-settings/{report.md,checks.log}`. Reviewer assigned Luna max; owner actual model/effort and reviewer telemetry were unobservable. Historical owner retry evidence remains historical; no suite was rerun for this reconciliation.
