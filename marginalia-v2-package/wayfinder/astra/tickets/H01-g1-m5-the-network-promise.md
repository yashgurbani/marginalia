...
## Question
`ui/consent.ts:45-46` promises an open-session web path that `codex-policy.ts` does not provide. Build the open-session path (about 250 lines) or correct the consent copy (about 10 lines)? Stage 1's honesty and Gate 5a wait on this.
