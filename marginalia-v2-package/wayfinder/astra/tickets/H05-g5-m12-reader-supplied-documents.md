# H05 G5 / M12: reader-supplied documents
...
## Question
Opening a PDF or local file is the largest silent scope cut against whitepaper line 217. In scope for the next plan, interim PDF fallback, or deferred with an honest "coming" state?
