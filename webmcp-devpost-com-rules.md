...
Deadline: Sep 4, 2026 @ 4:00am [EDT](https://devpost.com/settings/preferences_and_eligibility#eligibility-section)

[Join hackathon](https://webmcp.devpost.com/register?flow%5Bdata%5D%5Bchallenge_id%5D=31011&flow%5Bname%5D=register_for_challenge)

#### OpenAI WebMCP Challenge (the “Hackathon”) Official Rules
...
**Registration Period**: August 25th, 2026 (11:00 am Pacific Time) – September 3rd, 2026 (1:00 pm Pacific Time) (“Registration Period”).

**Submission Period**: August 25th, 2026 (11:00 am Pacific Time) – September 3rd, 2026 (1:00 pm Pacific Time) (“Submission Period”).

**Judging Period**: September 4th, 2026 (10:00 am Pacific Time) – September 21st, 2026 (5:00 pm Pacific Time) (“Judging Period”).

**Winners Announced**: On or around September 23rd, 2026 (2:00 pm Pacific Time).
...
- Individuals who are residents of countries and territories that currently support access to OpenAI’s API services listed here and are not excluded below: Supported countries and territories \| OpenAI API
- Teams of Eligible Individuals (“Teams”); and
- Organizations based in countries and territories that currently support access to OpenAI’s API services listed here: https://platform.openai.com/docs/supported-countries.  (including corporations, not-for-profit corporations and other nonprofit organizations, limited liability companies, partnerships, and other legal entities) that exist and have been organized or incorporated at the time of entry.
...
- Individuals or organizations who are not residents of, or Organizations domiciled in, a country, state, province or territory listed here: https://platform.openai.com/docs/supported-countries
...
Entrants may enter by visiting webmcp.devpost.com (“Hackathon Website”) and following the below steps:
...
- Get access to WebMCP. Download the ChatGPT desktop app and use its in-app browser, which supports WebMCP by default. Alternatively, download Google Chrome 149 or later, enable chrome://flags/#enable-webmcp-testing, and restart the browser.
- Make sure judges can access your working live project. Judges may test WebMCP tools using ChatGPT’s in-app browser or Google Chrome with WebMCP enabled.
- Optionally, install the Devpost Plugin from the Hackathon Website. Use of the Devpost Plugin is not required to enter or win. See Section 5 (Devpost Plugin) for terms of use.
- Optionally, Entrants may request 3,000 in free Netlify credits to enhance their Project for the Hackathon while supplies last and subject to approval. Free Netlify credits can only be requested by Entrants registered for the Hackathon. To request credits, complete the form at: https://forms.gle/xw75XGUQzCXEiALc7 by September 1st at 12pm PT. Netlify credits are not redeemable for cash and must be redeemed by October 3rd, 2026.
...
- Include a text description that explains
...
- Provide a URL to your public code repository (on GitHub, GitLab and Bitbucket) that must contain:
  ...
  - Those repositories should have the following:
...
- Include a demonstration video of your Project. The video portion of the Submission:
  - must be less than three (3) minutes. Judges are not required to watch beyond three minutes
  - must include a clear demo of your project functioning and with audio that covers what you built and how you used WebMCP
...
##### 5\. Devpost Hackathons Plugin (Optional)

The Hackathon offers an optional Devpost Plugin (the "Plugin") that Entrants may install in ChatGPT Codex to assist with discovering, registering for, building for, and submitting to the Hackathon. Use of the Plugin is not required to enter, participate in, or win the Hackathon. Entrants may complete every step of registration, building, and submission directly through the Hackathon Website at openai.devpost.com.

By installing or using the Plugin, the Entrant acknowledges and agrees to the following:

- Helper, not source of truth. The Plugin is an AI-assisted tool provided as a convenience. The Plugin is not the official source of any Hackathon information. The Official Rules, the Hackathon Website (openai.devpost.com), and any updates or notices issued by the Sponsor or Administrator govern in all cases. In the event of any conflict or inconsistency between the Plugin and the Official Rules or the Hackathon Website, the Official Rules and the Hackathon Website prevail.
- AI output may be inaccurate. The Plugin uses generative AI and may produce information that is inaccurate, incomplete, outdated, or otherwise unreliable. This includes, but is not limited to, statements about Hackathon rules, eligibility, deadlines, prizes, submission requirements, and judging criteria. The Entrant is solely responsible for verifying all such information against the Official Rules and the Hackathon Website before relying on it.
- Entrant remains responsible for compliance. Use of the Plugin does not modify, waive, or replace any requirement set forth in the Official Rules. The Entrant remains solely responsible for ensuring their registration, Submission, and conduct comply with the Official Rules and applicable law, regardless of any guidance, suggestion, output, or content produced by the Plugin.
- No warranty. The Plugin is provided "as is" and "as available," without warranty of any kind, express or implied. Neither the Sponsor nor the Administrator warrants that the Plugin will be uninterrupted, error-free, or secure, or that any output produced by the Plugin will be accurate, complete, or fit for any particular purpose.
- Limitation of liability. To the fullest extent permitted by law, the Released Parties (as defined in Section 10) shall not be liable for any damages of any kind arising from or relating to the Entrant's installation or use of the Plugin, including any reliance on Plugin output. Section 13 (Limitations of Liability) applies to use of the Plugin.
- Data, terms, and privacy. The Plugin may access Hackathon information through Devpost's authenticated services. The Entrant's use of the Plugin is also governed by the Devpost Terms of Service and Privacy Policy referenced in Sections 15 and 16.
- Acknowledgment. By installing or using the Plugin, the Entrant acknowledges they have read and understood this Section and agrees to its terms as a condition of using the Plugin.
...
| **WebMCP Challenge Winners** | Top 10 submissions receive the following prizes from the hackathon sponsors:<br>OpenAI<br>- $3,000 USD in cash<br>  <br>- Spotlight on @OpenAIDevs on Twitter<br>  <br>- Codex Micro<br>  <br>- Swag (for up to 3 team members)<br>  <br>- Pro Account for 1 year for up to 3 team members<br>  <br>Cloudflare<br>- $10,000 in Cloudflare credits<br>  <br>Vercel<br>- $300 per month in Vercel credits and $50 per month in Gateway credits for twelve months ($3,600 + $600 per winner).<br>  <br>Render<br>- $300 in Render credits<br>  <br>Netlify<br>- $500 in cash from Netlify<br>  <br>Shopify<br>- $250 in limited-edition Shopify Supply gear per winning submission.<br>  <br>Google Chrome<br>- 3-month subscription to Google AI Ultra per winning team member (~$300 value/team member). | 10 | All eligible Submissions |
...
[Previous image](https://webmcp.devpost.com/rules)[Next image](https://webmcp.devpost.com/rules)